...
tool={'type':'function','function':{'name':'lifeos_probe','description':'Return a diagnostic marker','parameters':{'type':'object','properties':{'marker':{'type':'string'}},'required':['marker'],'additionalProperties':False}}}
