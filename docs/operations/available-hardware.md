...
| laptop-board-01 | Candidate | Spare laptop motherboard | TBD | TBD | TBD | TBD | TBD | Physically available. Assess as a possible independent LifeOS inference/engineering worker once CPU, maximum/current RAM, GPU, storage interfaces, network interfaces and power requirements are identified. |
